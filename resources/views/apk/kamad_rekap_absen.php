<div class="apk-vector-header" style="padding-bottom: 70px; justify-content: space-between; align-items: flex-start; position: relative; background-image: linear-gradient(135deg, #10b981 0%, #059669 100%);">
    <div style="text-align: left;">
        <div style="font-size: 0.75rem; color: rgba(255,255,255,0.8); margin-bottom: 2px;">Kelas <?= htmlspecialchars($selected_class_name) ?></div>
    ...
    <div style="background: #fff; border: 1px solid #e2e8f0; border-radius: 16px; padding: 15px; margin-bottom: 20px; box-shadow: 0 4px 10px rgba(0,0,0,0.02);">
        <form action="" method="GET">
            <div style="margin-bottom: 10px;">
                <label style="display: block; font-size: 0.7rem; color: #64748b; font-weight: 700; margin-bottom: 4px;">Pilih Kelas</label>
                <select name="kelas_id" style="width: 100%; padding: 8px 10px; border: 1px solid #cbd5e1; border-radius: 8px; font-size: 0.8rem; outline: none; background: #f8fafc; color: #1e293b;">
