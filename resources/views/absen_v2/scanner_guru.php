...
<body>
    ...
    <div class="scanner-header">
        <div class="header-title">
            <i data-lucide="scan-face" style="color:#3b82f6;"></i>
            Scanner Absensi Guru
        </div>
        <button class="btn-close" onclick="window.close() || (window.location.href='/absen')">
            <i data-lucide="x"></i>
        </button>
    </div>
    ...
    <script>
        ...
        function handleScanSuccess(decodedText) {
            ...
            fetch('/absen/process-scan', {
                ...
                body: JSON.stringify({ nis: decodedText, mode: 'guru' })
            })
            .then(res => res.json())
            .then(data => {
                if(data.success) {
