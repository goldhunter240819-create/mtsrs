<div class="modern-page-header">
    <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 15px; width: 100%;">
        ...
        <a href="<?= \App\Core\Helper::url('/kurikulum/monitoring-nilai/global') ?>" target="_blank" class="btn" style="color: white; border: 1px solid rgba(255,255,255,0.4); background: rgba(255,255,255,0.1);">
            <i data-lucide="globe" style="color: white;"></i> Detail Global
        </a>
    </div>
</div>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center; vertical-align: middle;">
                            <div style="display: flex; gap: 8px; justify-content: center; flex-direction: column;">
                                <a href="<?= \App\Core\Helper::url('/kurikulum/monitoring-nilai/detail?kelas_id=' . $row['kelas_id'] . '&mapel_id=' . $row['mapel_id']) ?>" 
                                   class="z-btn" 
                                ...
                                <a href="<?= \App\Core\Helper::url('/kurikulum/monitoring-nilai/cetak?kelas_id=' . $row['kelas_id'] . '&mapel_id=' . $row['mapel_id']) ?>" 
