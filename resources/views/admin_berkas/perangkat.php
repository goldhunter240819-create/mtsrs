<?php
$title = $title ?? 'Perangkat Pembelajaran Guru | MTs RS';
$activeMenu = $activeMenu ?? 'manajemen_berkas_perangkat';
?>

<div class="modern-page-header">
    <div>
        <h1 class="mph-title"><i data-lucide="book-open"></i> Perangkat Pembelajaran Guru</h1>
        <p class="mph-subtitle">Kelola dan unduh arsip perangkat pembelajaran guru.</p>
    </div>
...
<div class="z-panel">
    <div class="z-panel-head">
        <h3 class="z-panel-title">Daftar Perangkat Pembelajaran</h3>
    </div>
            ...
            <tbody>
                ...
                <tr>
                    <td colspan="6" style="text-align: center; padding: 2rem; color: #64748b;">
                        Belum ada perangkat pembelajaran yang diunggah.
                    </td>
                </tr>
                ...
                <tr class="berkas-row-<?= $guruId ?>" style="display: none;">
                    ...
                    <td>
                        <div style="font-size: 0.85rem; color: #475569;"><i data-lucide="users" style="width: 14px; height: 14px; vertical-align: middle;"></i> <?= htmlspecialchars($d['nama_kelas'] ?? '-') ?></div>
                        <div style="font-size: 0.85rem; color: #475569;"><i data-lucide="book" style="width: 14px; height: 14px; vertical-align: middle;"></i> <?= htmlspecialchars($d['nama_mapel'] ?? '-') ?></div>
                    </td>
                    ...
                    <td style="text-align: center;">
                        <div style="display: flex; gap: 8px; justify-content: center;">
                            ...
                            <a href="<?= \App\Core\Helper::url('/manajemen-berkas/download/perangkat/' . $d['file_nama']) ?>" class="btn btn-sm" title="Download Berkas" style="display: inline-flex; align-items: center; gap: 6px; border-radius: 6px; font-weight: 600; color: #10b981; background: #ecfdf5; border: 1px solid #a7f3d0; box-shadow: 0 2px 4px rgba(16, 185, 129, 0.1);">
